...
//            H2DBUtil.displayTableRows(conn, "employees_projects");
            ...
            String query = "SELECT projects.title AS ProjectTitle, COUNT(employees_projects.employee_id) AS NumberOfEmployees "
                         + "FROM projects LEFT JOIN employees_projects ON projects.id = employees_projects.project_id "
                         + "GROUP BY project_id;";
